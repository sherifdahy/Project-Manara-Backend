...
public class Permissions
{
    ...
    //DepartmentUsers Permissions
    public const string GetDepartmentUsers = "departmentUsers:read";
    public const string CreateDepartmentUsers = "departmentUsers:create";
