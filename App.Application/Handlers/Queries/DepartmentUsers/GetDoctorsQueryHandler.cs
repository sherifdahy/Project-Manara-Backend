...
public class GetDoctorsQueryHandler(ApplicationDbContext context,DepartmentErrors departmentErrors) : IRequestHandler<GetDoctorsQuery, Result<PaginatedList<DepartmentUserResponse>>>
{
    private readonly ApplicationDbContext _context = context;
    private readonly DepartmentErrors _departmentErrors = departmentErrors;

    public async Task<Result<PaginatedList<DepartmentUserResponse>>> Handle(GetDoctorsQuery request, CancellationToken cancellationToken)
    {
        var query =
