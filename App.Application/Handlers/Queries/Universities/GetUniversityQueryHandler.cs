    ...
    ,IUnitOfWork unitOfWork) : IRequestHandler<GetUniversityQuery, Result<UniversityDetailResponse>>
{
    ...
    public async Task<Result<UniversityDetailResponse>> Handle(GetUniversityQuery request, CancellationToken cancellationToken)
    {
        ...
        //            .Any(r => r.Id == ur.RoleId && !(r.Name == RolesConstants.SystemAdmin || r.Name == RolesConstants.Admin || r.Name == RolesConstants.Member || r.Name == RolesConstants.Student)))),
        ...
        //                .Any(ur => ur.UserId == u.Id && _context.Roles.Any(r => r.Id == ur.RoleId && r.Name == RolesConstants.Student))),
        //                _context.Users.Count(u => u.FacultyId == f.Id && !u.IsDisabled && _context.UserRoles
        //                .Any(ur => ur.UserId == u.Id && _context.Roles
        //                    .Any(r => r.Id == ur.RoleId && !(r.Name == RolesConstants.SystemAdmin || r.Name == RolesConstants.Admin || r.Name == RolesConstants.Member || r.Name == RolesConstants.Student))))
        //            ))
        ...
        return Result.Success<UniversityDetailResponse>(null);
