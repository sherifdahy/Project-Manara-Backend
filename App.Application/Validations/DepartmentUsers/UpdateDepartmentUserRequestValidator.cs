...
public class UpdateDepartmentUserRequestValidator : AbstractValidator<UpdateDepartmentUserRequest>
{
    public UpdateDepartmentUserRequestValidator(JsonStringLocalizer localizer)
    {
        RuleFor(x => x.Name)
            .NotEmpty()
            .Length(3, 256);
